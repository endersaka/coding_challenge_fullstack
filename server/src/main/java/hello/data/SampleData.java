...
/**
 * User: maldana Date: 2/4/15 Time: 5:21 PM
 *
...
public final class SampleData {
  ...
  static final List<Ad> ADS = Arrays.asList(
      Ad.newAd().id(0).title("Title Nr. 0").description("Description 0")
          .imageUrl("https://i.ebayimg.com/00/s/MTAyNFg3Njg=/z/c0UAAOSwYXVcc6MM/$_72.JPG").build(),
      Ad.newAd().id(1).title("Title Nr. 1").description("Description 1")
          .imageUrl("https://i.ebayimg.com/00/s/MTAyNFg1Nzc=/z/87oAAOSwk45cc6MB/$_72.JPG").build(),
      Ad.newAd().id(2).title("Title Nr. 2").description("Description 2")
          .imageUrl("https://i.ebayimg.com/00/s/MTAyNFg3Njg=/z/FQMAAOSwnI9cc6EE/$_72.JPG").build(),
      Ad.newAd().id(3).title("Title Nr. 3").description("Description 3")
          .imageUrl("https://i.ebayimg.com/00/s/NzY4WDEwMjQ=/z/3UkAAOSwVVlcc6Mt/$_72.JPG").build(),
      Ad.newAd().id(4).title("Title Nr. 4").description("Description 4")
          .imageUrl("https://i.ebayimg.com/00/s/OTIxWDY0MA==/z/LKUAAOSwJ-xcc6MF/$_72.JPG").build(),
      Ad.newAd().id(5).title("Title Nr. 5").description("Description 5")
          .imageUrl("https://i.ebayimg.com/00/s/MTAyNFg1NzY=/z/F0QAAOSw~Kpcc6Ml/$_72.JPG").build(),
      Ad.newAd().id(6).title("Title Nr. 6").description("Description 6")
          .imageUrl("https://i.ebayimg.com/00/s/MTAyNFg3Njg=/z/AvoAAOSw-M9cc6K8/$_72.JPG").build(),
      Ad.newAd().id(7).title("Title Nr. 7").description("Description 7")
          .imageUrl("https://i.ebayimg.com/00/s/NzY4WDEwMjQ=/z/CvMAAOSw~7Jcc6Lz/$_72.JPG").build(),
      Ad.newAd().id(8).title("Title Nr. 8").description("Description 8")
          .imageUrl("https://i.ebayimg.com/00/s/MTAwN1gxMDI0/z/mBQAAOSwceZcc6Mx/$_72.JPG").build(),
      Ad.newAd().id(9).title("Title Nr. 9").description("Description 9")
          .imageUrl("https://i.ebayimg.com/00/s/NzY4WDEwMjQ=/z/7rEAAOSwVbhcc6K8/$_72.JPG").build(),
      Ad.newAd().id(10).title("Title Nr. 10").description("Description 10")
          .imageUrl("https://i.ebayimg.com/00/s/NzY4WDEwMjQ=/z/YKgAAOSw78xcY-a3/$_72.JPG").build(),
      Ad.newAd().id(11).title("Title Nr. 11").description("Description 11")
          .imageUrl("https://i.ebayimg.com/00/s/MTAyNFg1NzY=/z/aI0AAOSwtRNcc6Mo/$_72.JPG").build(),
      ...
      Ad.newAd().id(14).title("Title Nr. 14").description("Description 14")
          .imageUrl("https://i.ebayimg.com/00/s/NzY4WDEwMjQ=/z/IX8AAOSwWtpcc53S/$_72.JPG").build(),
      Ad.newAd().id(15).title("Title Nr. 15").description("Description 15")
          .imageUrl("https://i.ebayimg.com/00/s/NzY4WDEwMjQ=/z/uf8AAOSwGZRcc6My/$_72.JPG").build(),
      Ad.newAd().id(16).title("Title Nr. 16").description("Description 16")
          .imageUrl("https://i.ebayimg.com/00/s/NjQ0WDEwMjQ=/z/6OoAAOSwy1pbKA58/$_72.JPG").build(),
      Ad.newAd().id(17).title("Title Nr. 17").description("Description 17")
          .imageUrl("https://i.ebayimg.com/00/s/NzY4WDEwMjQ=/z/7rEAAOSwVbhcc6K8/$_72.JPG").build(),
      Ad.newAd().id(18).title("Title Nr. 18").description("Description 18")
          .imageUrl("https://i.ebayimg.com/00/s/NTc2WDEwMjQ=/z/zx0AAOSwd5xcc6Mw/$_72.JPG").build(),
      Ad.newAd().id(19).title("Title Nr. 19").description("Description 19")
          .imageUrl("https://i.ebayimg.com/00/s/MTAyNFg3Njg=/z/4yQAAOSw1Udcc6Iq/$_72.JPG").build(),
      Ad.newAd().id(20).title("Title Nr. 20").description("Description 20")
          .imageUrl("https://i.ebayimg.com/00/s/MTAyNFg1NzY=/z/q0AAAOSwejNcc6Lo/$_72.JPG").build(),
      Ad.newAd().id(21).title("Title Nr. 21").description("Description 21")
          .imageUrl("https://i.ebayimg.com/00/s/MTAyNFg1NzY=/z/F0QAAOSw~Kpcc6Ml/$_72.JPG").build(),
      Ad.newAd().id(22).title("Title Nr. 22").description("Description 22")
          .imageUrl("https://i.ebayimg.com/00/s/NTcwWDc5MA==/z/hqsAAOSwBlRcc6M1/$_72.JPG").build(),
      Ad.newAd().id(23).title("Title Nr. 23").description("Description 23")
          .imageUrl("https://i.ebayimg.com/00/s/MTAyNFg3Njg=/z/VZkAAOSwk4hcc6J5/$_72.JPG").build(),
      Ad.newAd().id(24).title("Title Nr. 24").description("Description 24")
          .imageUrl("https://i.ebayimg.com/00/s/MTAyNFg3Njg=/z/jMYAAOSwBRpcXE6F/$_72.JPG").build(),
      Ad.newAd().id(25).title("Title Nr. 25").description("Description 25")
          .imageUrl("https://i.ebayimg.com/00/s/MTAyNFg3Njg=/z/4yQAAOSw1Udcc6Iq/$_72.JPG").build(),
      Ad.newAd().id(26).title("Title Nr. 26").description("Description 26")
          .imageUrl("https://i.ebayimg.com/00/s/NzQzWDYzMA==/z/~vIAAOSwCcZcc6G0/$_72.JPG").build(),
      Ad.newAd().id(27).title("Title Nr. 27").description("Description 27")
          .imageUrl("https://i.ebayimg.com/00/s/NzY4WDEwMjQ=/z/3UkAAOSwVVlcc6Mt/$_72.JPG").build(),
      Ad.newAd().id(28).title("Title Nr. 28").description("Description 28")
          .imageUrl("https://i.ebayimg.com/00/s/NjgyWDEwMjQ=/z/wvsAAOSw-Jtcc6Np/$_72.JPG").build(),
      Ad.newAd().id(29).title("Title Nr. 29").description("Description 29")
          .imageUrl("https://i.ebayimg.com/00/s/MTAyNFg3Njg=/z/EdEAAOSw~jpcc6M7/$_72.JPG").build(),
      Ad.newAd().id(30).title("Title Nr. 30").description("Description 30")
          .imageUrl("https://i.ebayimg.com/00/s/NTcwWDc5MA==/z/hqsAAOSwBlRcc6M1/$_72.JPG").build(),
      Ad.newAd().id(31).title("Title Nr. 31").description("Description 31")
          .imageUrl("https://i.ebayimg.com/00/s/NTc2WDEwMjQ=/z/nr0AAOSwOztcc6MM/$_72.JPG").build(),
      ...
      Ad.newAd().id(33).title("Title Nr. 33").description("Description 33")
          .imageUrl("https://i.ebayimg.com/00/s/MTAyNFg1NzY=/z/iWoAAOSw0yVcc6G~/$_72.JPG").build(),
      Ad.newAd().id(34).title("Title Nr. 34").description("Description 34")
          .imageUrl("https://i.ebayimg.com/00/s/NTc2WDg1Mg==/z/6yEAAOSwL35cc6Cu/$_72.JPG").build(),
      Ad.newAd().id(35).title("Title Nr. 35").description("Description 35")
          .imageUrl("https://i.ebayimg.com/00/s/MTAyNFg1NzY=/z/EmUAAOSwUvVcc6MZ/$_72.JPG").build(),
      Ad.newAd().id(36).title("Title Nr. 36").description("Description 36")
          .imageUrl("https://i.ebayimg.com/00/s/OTIxWDY0MA==/z/LKUAAOSwJ-xcc6MF/$_72.JPG").build(),
      Ad.newAd().id(37).title("Title Nr. 37").description("Description 37")
          .imageUrl("https://i.ebayimg.com/00/s/MTAyNFg1NzY=/z/gbkAAOSw6nhcc6Mi/$_72.JPG").build(),
      Ad.newAd().id(38).title("Title Nr. 38").description("Description 38")
          .imageUrl("https://i.ebayimg.com/00/s/MTAyNFg3Njg=/z/VZkAAOSwk4hcc6J5/$_72.JPG").build(),
      Ad.newAd().id(39).title("Title Nr. 39").description("Description 39")
          .imageUrl("https://i.ebayimg.com/00/s/ODYwWDEwMjQ=/z/z~UAAOSw8Alcc6Mq/$_72.JPG").build(),
      Ad.newAd().id(40).title("Title Nr. 40").description("Description 40")
          .imageUrl("https://i.ebayimg.com/00/s/NTMxWDEwMjQ=/z/nd8AAOSwqeRcc6NB/$_72.JPG").build(),
      Ad.newAd().id(41).title("Title Nr. 41").description("Description 41")
          .imageUrl("https://i.ebayimg.com/00/s/MTAyNFg1NzY=/z/cEsAAOSwC4lcc6Mw/$_72.JPG").build(),
      Ad.newAd().id(42).title("Title Nr. 42").description("Description 42")
          .imageUrl("https://i.ebayimg.com/00/s/NTc2WDEwMjQ=/z/zx0AAOSwd5xcc6Mw/$_72.JPG").build(),
      Ad.newAd().id(43).title("Title Nr. 43").description("Description 43")
          .imageUrl("https://i.ebayimg.com/00/s/NzY4WDEwMjQ=/z/QlMAAOSwxDxcc6M0/$_72.JPG").build(),
      ...
      Ad.newAd().id(46).title("Title Nr. 46").description("Description 46")
          .imageUrl("https://i.ebayimg.com/00/s/MTAyNFg3Njg=/z/lCQAAOSwNIpcc6NP/$_72.JPG").build(),
      Ad.newAd().id(47).title("Title Nr. 47").description("Description 47")
          .imageUrl("https://i.ebayimg.com/00/s/MTAyNFg3NjY=/z/y-YAAOSwyMRcc6Jk/$_72.JPG").build(),
      Ad.newAd().id(48).title("Title Nr. 48").description("Description 48")
          .imageUrl("https://i.ebayimg.com/00/s/NzY4WDEwMjQ=/z/7rEAAOSwVbhcc6K8/$_72.JPG").build(),
      Ad.newAd().id(49).title("Title Nr. 49").description("Description 49")
          .imageUrl("https://i.ebayimg.com/00/s/MTAyNFg3Njg=/z/OK8AAOSwUYhcc6H9/$_72.JPG").build(),
      ...
      Ad.newAd().id(52).title("Title Nr. 52").description("Description 52")
          .imageUrl("https://i.ebayimg.com/00/s/MTAyNFg3Njg=/z/hpsAAOSw0pJcc6Ka/$_72.JPG").build(),
      Ad.newAd().id(53).title("Title Nr. 53").description("Description 53")
          .imageUrl("https://i.ebayimg.com/00/s/MTAyNFg2Nzc=/z/Wy4AAOSwNqRcEMux/$_72.JPG").build(),
      Ad.newAd().id(54).title("Title Nr. 54").description("Description 54")
          .imageUrl("https://i.ebayimg.com/00/s/MTAyNFg1NzY=/z/rBsAAOSwgs5cc6KQ/$_72.JPG").build(),
      Ad.newAd().id(55).title("Title Nr. 55").description("Description 55")
          .imageUrl("https://i.ebayimg.com/00/s/MTAyNFg1NzY=/z/gw8AAOSw32lcc6AS/$_72.JPG").build(),
  ...
  public static void main(String[] args) {
    ...
    for (int i = 0; i < 60; i++) {
      builder.append(format(
          "Ad.newAd().id(%1$d).title(\"Title Nr. %1$d\").description(\"Description %1$d\").imageUrl(\"%2$s\").build(),\n",
          i, sampleImage()));
